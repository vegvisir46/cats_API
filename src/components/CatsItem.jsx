...
function CatsItem(props) {
    const { url, id, className, onClickFunction } = props;
    return (
        <div
            onClick={() => {
                onClickFunction(id, url);
            }}
            className="main__images-block"
        >
            <i className="main__images-icon">
                <svg
                    width="40"
                    height="37"
                    viewBox="0 0 40 37"
            ...
            <i className={classNames(className, 'main__images-icon_hover')}>
                <svg
                    width="40"
                    height="37"
                    viewBox="0 0 40 37"
            ...
            <img className="main__images-img" src={url} alt="котик" />
        </div>
    );
}
